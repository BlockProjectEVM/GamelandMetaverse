...
public class CoinExManager : MonoBehaviour
{
    #region Singleton
    public static CoinExManager Instance;
    private void Awake()
    {
        if (Instance == null)
        {
    ...
    // address of contract
    const string contractERC20 = "0x144F30DD3e1D41313a33E4129A232EEB7e3B5d45";

    const string chain = "CoinEx";
    // set network mainnet, testnet
    const string network = "testnet";
    const string chainId = "15555";

    const string networkRPC = "https://api.testnet-dev.trust.one";



    float[] coinCost = { 0.25f, 0.50f, 0.75f, 1.00f};
